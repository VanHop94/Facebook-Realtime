...
public class PostDetail {
	...
	public PostDetail(PostDetail postDetail) {
		this.post_id = postDetail.getPost_id();
	...
	public PostDetail(long id, String postId, String pageId, String message, long update_util, long like_count,
			long comment_count, long share_count, long update_time, String picture, long created_time, HumanDetail user,
			int status, long begin_time, String managerId) {
		super();
		this.id = id;
		this.post_id = postId;
		this.pageId = pageId;
	...
	/*public void addUsers(List<UserDetail> users) {
		...
		for (UserDetail user : users) {
			if (listUsers.get(user.getId()) == null) {
	...
	/*public void addComments(List<CommentDetail> comments) {
		...
		for (CommentDetail comment : comments) {
			if (listComments.get(comment.getId()) == null
					|| listComments.get(comment.getId()).getLike_count() != comment.getLike_count()) {
				listComments.put(comment.getId(), comment);
